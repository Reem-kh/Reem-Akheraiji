...
[<img src="./Daniels%20Distinction%20Thesis%20Lable.png" height="37"/>](#DanielsDistinction)
...
- **Health Sector:** I spearheaded a team in tackling a client case in the US health sector. We addressed the challenge of a hospital chain receiving only 94% of the medical tools  ordered from their medical supplier. By analyzing the supplier's dataset, asking the client critical questions, and identifying the root cause of the problem within the supply chain process, we developed a strategy to improve and control the supply chain, increasing fulfillment to over 98%.
